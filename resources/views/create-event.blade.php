            ...
            <div class="bg-white shadow-sm border-0 rounded-2xl">
                <div class="p-8">
                    <form action="{{ route('events.store') }}" method="POST" enctype="multipart/form-data">
                        ...
                        <!-- Buttons -->
                        <div class="d-flex justify-between pt-3">
                            <a href="{{ route('dashboard') }}" class="btn btn-secondary rounded-lg px-5 fw-semibold">
                                Cancel
                            </a>
                            <div class="d-flex gap-3">
                                <button type="submit" name="action" value="publish" class="px-5 fw-semibold bg-[#01044e] border-1 border-[#01044e] text-white rounded-lg hover:opacity-50">
                                    <i class="bi bi-plus-circle me-2"></i>Publish
                                </button>
                                <button type="submit" name="action" value="draft" class="px-5 fw-semibold border-1 border-[#01044e] text-[#01044e] rounded-lg hover:opacity-50">
